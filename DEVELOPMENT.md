...
```bash
git remote add encore encore://vqc-temple-dashboard-9nh2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/vqc-temple-dashboard-9nh2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/vqc-temple-dashboard-9nh2/settings/integrations/github)
